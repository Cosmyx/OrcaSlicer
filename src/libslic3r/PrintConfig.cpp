...
void PrintConfigDef::init_fff_params()
{
    ...
    def->tooltip = L(
        ...
        "set appropriately. OrcaCosmyx ensures that adaptive_bed_mesh_min/adaptive_bed_mesh_max values do not exceed these min/max "
...
CLIMiscConfigDef::CLIMiscConfigDef()
{
    ...
    def->tooltip = L("This version of OrcaCosmyx may not understand configurations produced by the newest OrcaCosmyx versions. "
                     "For example, newer OrcaCosmyx may extend the list of supported firmware flavors. One may decide to "
    ...
    def->tooltip = L("If enabled, the command line arguments are sent to an existing instance of GUI OrcaCosmyx, "
                     "or an existing OrcaCosmyx window is activated. "
...
ReadWriteSlicingStatesConfigDef::ReadWriteSlicingStatesConfigDef()
{
    ...
    def->tooltip = L("Position of the extruder at the beginning of the custom G-code block. If the custom G-code travels somewhere else, "
                     "it should write to this variable so OrcaCosmyx knows where it travels from when it gets control back.");
    ...
    def->tooltip = L("Retraction state at the beginning of the custom G-code block. If the custom G-code moves the extruder axis, "
                     "it should write to this variable so OrcaCosmyx de-retracts correctly when it gets control back.");
