...
// When parsing a configuration value, if the old_value is not understood by this OrcaCosmyx version,
// it is being substituted with some default value that this OrcaCosmyx could work with.
