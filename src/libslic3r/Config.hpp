...
// When parsing a configuration value, if the old_value is not understood by this CosmoSlice version,
// it is being substituted with some default value that this CosmoSlice could work with.
