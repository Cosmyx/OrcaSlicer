...
static const std::string VERSION_CHECK_URL = "https://check-version.orcacosmyx.com/latest";
static const std::string PROFILE_UPDATE_URL = "https://api.github.com/repos/OrcaCosmyx/orcacosmyx-profiles/releases/tags";
