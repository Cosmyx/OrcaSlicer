...
#define GCODEVIEWER_APP_NAME "OrcaCosmyx G-code Viewer"
#define GCODEVIEWER_APP_KEY  "OrcaCosmyxGcodeViewer"
#define GCODEVIEWER_BUILD_ID std::string("OrcaCosmyx G-code Viewer-") + std::string(SLIC3R_VERSION) + std::string("-RC")
