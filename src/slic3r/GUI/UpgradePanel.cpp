...
static const wxColour TEXT_NORMAL_CLR = wxColour(162, 0, 255);
    ...
    :wxPanel(parent, id, pos, size, style)
{
    ...
    StateColor btn_bg(std::pair<wxColour, int>(wxColour(255, 255, 255), StateColor::Disabled), std::pair<wxColour, int>(wxColour(188, 79, 250), StateColor::Pressed),
                      std::pair<wxColour, int>(wxColour(115, 79, 182), StateColor::Hovered), std::pair<wxColour, int>(wxColour(162, 0, 255), StateColor::Enabled),
                      std::pair<wxColour, int>(wxColour(162, 0, 255), StateColor::Normal));
    StateColor btn_bd(std::pair<wxColour, int>(wxColour(144, 144, 144), StateColor::Disabled), std::pair<wxColour, int>(wxColour(162, 0, 255), StateColor::Enabled));
