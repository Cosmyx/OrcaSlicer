    ...
    , m_mapping_tutorial_popup(AmsTutorialPopup(this))
{
    ...
    m_btn_bg_enable = StateColor(std::pair<wxColour, int>(wxColour(188, 79, 250), StateColor::Pressed), std::pair<wxColour, int>(wxColour(115, 79, 182), StateColor::Hovered),
    ...
    m_ams_backup_tip->SetForegroundColour(wxColour(0xA200FF));
