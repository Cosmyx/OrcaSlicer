    ...
    : wxPanel(parent, wxID_ANY, wxDefaultPosition, wxDefaultSize)
{
    ...
    this->logo = ScalableBitmap(this, Slic3r::var("OrcaCosmyx_192px.png"), wxBITMAP_TYPE_PNG);
        ...
        wxDefaultSize, /*wxCAPTION*/wxDEFAULT_DIALOG_STYLE)
{
    ...
    // logo
    m_logo_bitmap = ScalableBitmap(this, is_dark ? "OrcaCosmyx_about_dark" : "OrcaCosmyx_about", 125);
    ...
    text_list.push_back(_L("OrcaCosmyx is based on BambuStudio, PrusaSlicer, and SuperSlicer."));
