...
wxString CopyrightsDialog::get_html_text()
{
    ...
    wxString text = wxString::Format(
        ...
        _L("License"),
        _L("CosmoSlice is licensed under "),
        "https://www.gnu.org/licenses/agpl-3.0.html",_L("GNU Affero General Public License, version 3"),
        _L("CosmoSlice is based on PrusaSlicer and BambuStudio"),
        _L("Libraries"),
        ...
        wxDefaultSize, /*wxCAPTION*/wxDEFAULT_DIALOG_STYLE)
{
    ...
    // version
    {
        ...
        auto          version_string = std::string(SoftFever_VERSION); // _L("CosmoSlice ") + " " + std::string(SoftFever_VERSION);
