    ...
    : wxPanel(parent, wxID_ANY, wxDefaultPosition, wxDefaultSize)
{
    ...
    this->logo = ScalableBitmap(this, Slic3r::var("CosmoSlice_192px.png"), wxBITMAP_TYPE_PNG);
...
wxString CopyrightsDialog::get_html_text()
{
    ...
    wxString text = wxString::Format(
        ...
        _L("License"),
        _L("Orca Cosmyx is licensed under "),
        "https://www.gnu.org/licenses/agpl-3.0.html",_L("GNU Affero General Public License, version 3"),
        _L("Orca Cosmyx is based on PrusaSlicer and BambuStudio"),
        _L("Libraries"),
        ...
        wxDefaultSize, /*wxCAPTION*/wxDEFAULT_DIALOG_STYLE)
{
    ...
    // logo
    m_logo_bitmap = ScalableBitmap(this, is_dark ? "CosmoSlice_about_dark" : "CosmoSlice_about", 125);
    ...
    // version
    {
        ...
        auto          version_string = std::string(SoftFever_VERSION); // _L("Orca Cosmyx ") + " " + std::string(SoftFever_VERSION);
    ...
    text_list.push_back(_L("CosmoSlice is based on BambuStudio, PrusaSlicer, and SuperSlicer."));
    ...
    m_html = new wxHtmlWindow(this, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxHW_SCROLLBAR_NEVER /*NEVER*/);
      {
          ...
          const auto text = from_u8(
              ...
              "<html>"
              "<body>"
              "<p style=\"text-align:left\"><a style=\"color:#009789\" href=\"https://github.com/SoftFever/Orcacosmyx\">https://github.com/SoftFever/Orcacosmyx</ a></p>"
              "</body>"
              "</html>")
            ).str());
          m_html->SetPage(text);
