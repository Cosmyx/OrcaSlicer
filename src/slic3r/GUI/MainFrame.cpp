...
#ifdef __APPLE__
class OrcaCosmyxTaskBarIcon : public wxTaskBarIcon
{
public:
    OrcaCosmyxTaskBarIcon(wxTaskBarIconType iconType = wxTBI_DEFAULT_TYPE) : wxTaskBarIcon(iconType) {}
...
#else // _WIN32
    return wxIcon(Slic3r::var("OrcaCosmyx_128px.png"), wxBITMAP_TYPE_PNG);
#endif // _WIN32
}
...
*/
    ...
    case GUI_App::EAppMode::Editor:
        m_taskbar_icon = std::make_unique<OrcaCosmyxTaskBarIcon>(wxTBI_DOCK);
        m_taskbar_icon->SetIcon(wxIcon(Slic3r::var("OrcaCosmyx-mac_256px.ico"), wxBITMAP_TYPE_ICO), "OrcaCosmyx");
        break;
...
void MainFrame::update_side_button_style()
{
    ...
    StateColor m_btn_bg_enable = StateColor(
        std::pair<wxColour, int>(wxColour(188, 79, 250), StateColor::Pressed),
        std::pair<wxColour, int>(wxColour(48, 221, 112), StateColor::Hovered),
        std::pair<wxColour, int>(wxColour(162, 0, 255), StateColor::Normal)
    );
...
// See https://github.com/Cosmyx/OrcaSlicer/issues/8152
...
static wxMenu* generate_help_menu()
{
    ...
    // Report a bug
    //append_menu_item(helpMenu, wxID_ANY, _L("Report Bug(TODO)"), _L("Report a bug of OrcaCosmyx"),
    //    [](wxCommandEvent&) {
    //        //TODO
    //    });
    // Check New Version
...
void MainFrame::init_menubar_as_editor()
{
    ...
    //auto preference_item = new wxMenuItem(parent_menu, OrcaCosmyxMenuPreferences + bambu_studio_id_base, _L("Preferences") + "\t" + ctrl + ",", "");
#else
...
//    });
...
#ifdef __APPLE__
    wxString about_title = wxString::Format(_L("&About %s"), SLIC3R_APP_FULL_NAME);
    //auto about_item = new wxMenuItem(parent_menu, OrcaCosmyxMenuAbout + bambu_studio_id_base, about_title, "");
        //parent_menu->Bind(wxEVT_MENU, [this, bambu_studio_id_base](wxEvent& event) {
        //    switch (event.GetId() - bambu_studio_id_base) {
        //        case OrcaCosmyxMenuAbout:
        //            Slic3r::GUI::about();
        //            break;
        //        case OrcaCosmyxMenuPreferences:
        //            CallAfter([this] {
        //                PreferencesDialog dlg(this);
        //                dlg.ShowModal();
        //#if ENABLE_GCODE_LINES_ID_IN_H_SLIDER
    ...
    append_menu_item(m_topbar->GetCalibMenu(), wxID_ANY, _L("Tutorial"), _L("Calibration help"),
        [this](wxCommandEvent&) {
            std::string url = "https://github.com/Cosmyx/OrcaSlicer/wiki/Calibration";
            if (const std::string country_code = wxGetApp().app_config->get_country_code(); country_code == "CN") {
                // Use gitee mirror for China users
                url = "https://gitee.com/n0isyfox/orca-cosmyx-docs/wikis/%E6%A0%A1%E5%87%86/%E6%89%93%E5%8D%B0%E5%8F%82%E6%95%B0%E6%A0%A1%E5%87%86";
            }
    ...
    append_menu_item(calib_menu, wxID_ANY, _L("Tutorial"), _L("Calibration help"),
        [this](wxCommandEvent&) { wxLaunchDefaultBrowser("https://github.com/Cosmyx/OrcaSlicer/wiki/Calibration", wxBROWSER_NEW_WINDOW); }, "", nullptr,
        [this]() {return m_plater->is_view3D_shown();; }, this);
...
#else
    SetIcon(wxIcon(var("OrcaCosmyx_128px.png"), wxBITMAP_TYPE_PNG));
#endif // _WIN32
