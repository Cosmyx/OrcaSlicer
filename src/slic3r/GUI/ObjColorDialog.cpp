...
const  StateColor ok_btn_bg(std::pair<wxColour, int>(wxColour(188, 79, 250), StateColor::Pressed),
...
{
    auto       btn_sizer = new wxBoxSizer(wxHORIZONTAL);
    StateColor calc_btn_bg(std::pair<wxColour, int>(wxColour(188, 79, 250), StateColor::Pressed), std::pair<wxColour, int>(wxColour(115, 79, 182), StateColor::Hovered),
                           std::pair<wxColour, int>(wxColour(162, 0, 255), StateColor::Normal));
    StateColor calc_btn_bd(std::pair<wxColour, int>(wxColour(162, 0, 255), StateColor::Normal));
