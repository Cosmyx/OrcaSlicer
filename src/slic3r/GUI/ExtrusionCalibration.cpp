...
void ExtrusionCalibration::create()
{
    ...
    m_btn_bg_green = StateColor(std::pair<wxColour, int>(wxColour(238, 238, 238), StateColor::Disabled), std::pair<wxColour, int>(wxColour(188, 79, 250), StateColor::Pressed), std::pair<wxColour, int>(wxColour(115, 79, 182), StateColor::Hovered),
    ...
    m_button_cali->SetBorderColor({ std::pair<wxColour, int>(wxColour(238, 238, 238), StateColor::Disabled), std::pair<wxColour, int>(wxColour(162, 0, 255), StateColor::Enabled) });
    ...
    m_btn_bg_green = StateColor(std::pair<wxColour, int>(wxColour(188, 79, 250), StateColor::Pressed), std::pair<wxColour, int>(wxColour(115, 79, 182), StateColor::Hovered),
        std::pair<wxColour, int>(wxColour(162, 0, 255), StateColor::Normal));
    m_cali_cancel->SetBackgroundColor(m_btn_bg_green);
    m_cali_cancel->SetBorderColor(wxColour(162, 0, 255));
    ...
    m_button_save_result->SetBorderColor(wxColour(162, 0, 255));
