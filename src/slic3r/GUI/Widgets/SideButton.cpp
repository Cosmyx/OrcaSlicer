    ...
    , state_handler(this)
{
    ...
    border_color.append(wxColour(188, 79, 250), StateColor::Pressed);
    border_color.append(wxColour(115, 79, 182), StateColor::Hovered);
    border_color.append(0xA200FF, StateColor::Normal);
    ...
    background_color.append(wxColour(188, 79, 250), StateColor::Pressed);
    background_color.append(wxColour(115, 79, 182), StateColor::Hovered);
    background_color.append(0xA200FF, StateColor::Normal);
