    ...
    , m_show_history_dialog(show)
{
    ...
    mew_btn->SetBorderColor(wxColour(162, 0, 255));
...
void HistoryWindow::sync_history_data() {
    ...
    for (auto& result : m_calib_results_history) {
        ...
        StateColor btn_bg_green(std::pair<wxColour, int>(wxColour(188, 79, 250), StateColor::Pressed),
            std::pair<wxColour, int>(wxColour(115, 79, 182), StateColor::Hovered),
            std::pair<wxColour, int>(wxColour(162, 0, 255), StateColor::Normal));
        edit_button->SetBackgroundColour(*wxWHITE);
        edit_button->SetBackgroundColor(btn_bg_green);
        edit_button->SetBorderColor(wxColour(162, 0, 255));
    ...
    , m_new_result(result)
{
    ...
    save_btn->SetBorderColor(wxColour(162, 0, 255));
    ...
    , m_history_results(history_results)
{
    ...
    ok_btn->SetBorderColor(wxColour(162, 0, 255));
