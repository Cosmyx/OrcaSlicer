...
wxBoxSizer* PreferencesDialog::create_item_link_association( wxString url_prefix, wxString website_name)
{
    ...
    wxString tooltip = _L("Associate") + " " + url_prefix + ":// " + _L("with OrcaCosmyx so that Orca can open models from") + " " + website_name;
...
void PreferencesDialog::create_items()
{
    ...
    auto item_single_instance  = create_item_checkbox(_L("Allow only one OrcaCosmyx instance"),
    #if __APPLE__
    ...
    #else
            _L("If this is enabled, when starting OrcaCosmyx and another instance of the same OrcaCosmyx is already running, that instance will be reactivated instead."),
    #endif
            "single_instance");
    ...
    g_sizer->Add(create_item_title(_L("Associate files to OrcaCosmyx")), 1, wxEXPAND);

    auto item_associate_3mf    = create_item_checkbox(_L("Associate .3mf files to OrcaCosmyx"), _L("If enabled, sets OrcaCosmyx as default application to open .3mf files") , "associate_3mf");
    g_sizer->Add(item_associate_3mf);

    auto item_associate_stl    = create_item_checkbox(_L("Associate .stl files to OrcaCosmyx"), _L("If enabled, sets OrcaCosmyx as default application to open .stl files") , "associate_stl");
    g_sizer->Add(item_associate_stl);

    auto item_associate_step   = create_item_checkbox(_L("Associate .step/.stp files to OrcaCosmyx"), _L("If enabled, sets OrcaCosmyx as default application to open .step files"), "associate_step");
    g_sizer->Add(item_associate_step);

    //// ASSOCIATE > WebLinks
    g_sizer->Add(create_item_title(_L("Associate web links to OrcaCosmyx")), 1, wxEXPAND);
