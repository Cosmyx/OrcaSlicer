...
void AMSMaterialsSetting::create()
{
    ...
    m_button_confirm->SetBorderColor(wxColour(162, 0, 255));
...
void AMSMaterialsSetting::create_panel_normal(wxWindow* parent)
{
    ...
    m_readonly_filament->SetBorderColor(StateColor(std::make_pair(0xDBDBDB, (int)StateColor::Focused), std::make_pair(0xA200FF, (int)StateColor::Hovered),
