...
static const wxColour BUTTON_HOVER_COL   = wxColour(162, 0, 255);
...
static const wxColour STAGE_TEXT_COL      = wxColour(162, 0, 255);
...
void PrintingTaskPanel::create_panel(wxWindow* parent)
{
   ...
   /* wxFlexGridSizer *fgSizer_task = new wxFlexGridSizer(2, 2, 0, 0);
    ...
    m_staticText_progress_percent->SetForegroundColour(wxColour(162, 0, 255));
    ...
    m_staticText_progress_percent_icon->SetForegroundColour(wxColour(162, 0, 255));
    ...
    StateColor btn_bg_green(std::pair<wxColour, int>(AMS_CONTROL_DISABLE_COLOUR, StateColor::Disabled), std::pair<wxColour, int>(wxColour(188, 79, 250), StateColor::Pressed),
                            std::pair<wxColour, int>(wxColour(115, 79, 182), StateColor::Hovered), std::pair<wxColour, int>(AMS_CONTROL_BRAND_COLOUR, StateColor::Normal));
...
wxBoxSizer *StatusBasePanel::create_misc_control(wxWindow *parent)
{
    ...
    m_switch_nozzle_fan->Bind(wxEVT_ENTER_WINDOW, [this](auto& e) {
        m_fan_panel->SetBackgroundColor(wxColour(162, 0, 255));
    });
