...
void MsgDialog::apply_style(long style)
{
    ...
    logo->SetBitmap( create_scaled_bitmap(style & wxAPPLY        ? "completed" :
                                          ...
                                          style & wxICON_QUESTION       ? "question"    : "CosmoSlice", this, 64, style & wxICON_ERROR));
}
	...
	, msg(msg)
{
	...
	logo->SetBitmap(create_scaled_bitmap("CosmoSlice_192px_grayscale.png", this, monospaced_font ? 48 : /*1*/84));
...
wxBoxSizer *Newer3mfVersionDialog::get_msg_sizer()
{
    ...
    if (file_version_newer) { 
        text1 = new wxStaticText(this, wxID_ANY, _L("The 3mf file version is in Beta and it is newer than the current CosmoSlice version."));
