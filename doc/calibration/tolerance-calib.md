...
To correct for these variations, OrcaCosmyx provides:

- Filament Compensation:

  - Shrinkage (XY)

    ![FilamentShrinkageCompensation](https://github.com/SoftFever/OrcaCosmyx/blob/main/doc/images/Tolerance/FilamentShrinkageCompensation.png?raw=true)
...
- Process Compensation:
  ...
  - Precise Z height
    ...
    ![QualityPrecision](https://github.com/SoftFever/OrcaCosmyx/blob/main/doc/images/Tolerance/QualityPrecision.png?raw=true)

## Handy Models

OrcaCosmyx includes several handy models to help you test and calibrate your printer.  
Right-click on your plate in Prepare mode and select "Add Handy Model" to access these models.  
![handy-models-list](https://github.com/SoftFever/OrcaCosmyx/blob/main/doc/images/Handy-Models/handy-models-list.png?raw=true)
...
![tolerance_hole](https://github.com/SoftFever/OrcaCosmyx/blob/main/doc/images/Tolerance/tolerance_hole.svg?raw=true)
...
![OrcaToleranceTes_m6](https://github.com/SoftFever/OrcaCosmyx/blob/main/doc/images/Tolerance/OrcaToleranceTes_m6.jpg?raw=true)
![OrcaToleranceTest_print](https://github.com/SoftFever/OrcaCosmyx/blob/main/doc/images/Tolerance/OrcaToleranceTest_print.jpg?raw=true)
