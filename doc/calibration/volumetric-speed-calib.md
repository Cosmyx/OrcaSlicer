...
![mvf_measurement_point](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/MVF/mvf_measurement_point.jpg?raw=true)

Use calipers or a ruler to measure the **height** of the model just before the defects begin.  
![mvf_caliper_sample_mvf](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/MVF/mvf_caliper_sample_mvf.jpg?raw=true)
...
- Use CosmoSlice in the "Preview" tab, make sure the color scheme "flow" is selected. Scroll down to the layer height that you measured, and click on the toolhead slider. This will indicate the max flow level for your filament.  
![mvf_gui_flow](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/MVF/mvf_gui_flow.png?raw=true)
...
![mvf_material_settings](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/MVF/mvf_material_settings.png?raw=true)
