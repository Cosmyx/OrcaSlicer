...
CosmoSlice includes three approaches for calibrating the Pressure Advance value. Each method has its own advantages and disadvantages. It is important to note that each method has two versions: one for a direct-drive extruder and one for a Bowden extruder. Make sure to select the appropriate version for your test.
...
![pressure_advance_enable](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/pa/pressure_advance_enable.png?raw=true)
...
3. In this example a height of 8 mm was selected, so the Pressure Advance value should be calculated as `PressureAdvanceStart + (PressureAdvanceStep x measured)`; example: `0 + (0.002 x 8) = 0.016`.
   ![pa-tower](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/pa/pa-tower.jpg?raw=true)
   ![pa-tower-measure](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/pa/pa-tower-measure.jpg?raw=true)
...
[Instructions for using and reading the pattern method](https://ellis3dp.com/Print-Tuning-Guide/articles/pressure_linear_advance/pattern_method.html) are provided in [Ellis' Print Tuning Guide](https://ellis3dp.com/Print-Tuning-Guide/), with only a few CosmoSlice differences to note.
...
1. Single test \
   ![pa-pattern-single](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/pa/pa-pattern-single.png?raw=true)
...
![pa-pattern-batch-plater](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/pa/pa-pattern-batch-plater.png?raw=true)
...
![pa-pattern-batch-objects](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/pa/pa-pattern-batch-objects.png?raw=true)

Next, Ellis' generator provided the ability to adjust specific printer, filament, and print profile settings. You can make these same changes in CosmoSlice by adjusting the settings in the Prepare pane as you would with any other print. When you initiate the calibration test, Ellis' default settings are applied. A few things to note about these settings:
...
3. In this test, a Pressure Advance value of `0.016` appears to be optimal.
   ...
   ![pa-line](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/pa/pa-line.gif?raw=true)

   ![pa-lines](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/pa/pa-lines.png?raw=true)

   ![pa-line-0-016](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/pa/pa-line-0-016.png?raw=true)
