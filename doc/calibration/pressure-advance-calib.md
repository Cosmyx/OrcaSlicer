...
![pressure_advance_enable](https://github.com/Cosmyx/OrcaSlicer/blob/main/doc/images/pa/pressure_advance_enable.png?raw=true)
...
3. In this example a height of 8 mm was selected, so the Pressure Advance value should be calculated as `PressureAdvanceStart + (PressureAdvanceStep x measured)`; example: `0 + (0.002 x 8) = 0.016`.
   ![pa-tower](https://github.com/Cosmyx/OrcaSlicer/blob/main/doc/images/pa/pa-tower.jpg?raw=true)
...
1. Single test \
   ![pa-pattern-single](https://github.com/Cosmyx/OrcaSlicer/blob/main/doc/images/pa/pa-pattern-single.png?raw=true)
...
![pa-pattern-batch-plater](https://github.com/Cosmyx/OrcaSlicer/blob/main/doc/images/pa/pa-pattern-batch-plater.png?raw=true)
...
![pa-pattern-batch-objects](https://github.com/Cosmyx/OrcaSlicer/blob/main/doc/images/pa/pa-pattern-batch-objects.png?raw=true)
...
3. In this test, a Pressure Advance value of `0.016` appears to be optimal.
   ...
   ![pa-line](https://github.com/Cosmyx/OrcaSlicer/blob/main/doc/images/pa/pa-line.gif?raw=true)

   ![pa-lines](https://github.com/Cosmyx/OrcaSlicer/blob/main/doc/images/pa/pa-lines.png?raw=true)

   ![pa-line-0-016](https://github.com/Cosmyx/OrcaSlicer/blob/main/doc/images/pa/pa-line-0-016.png?raw=true)
