...
![apa-material-config](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/pa/apa-material-config.png?raw=true)
...
![apa-expected-results](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/pa/apa-expected-results.jpg?raw=true)

In addition, seams should appear smooth with no bulging or under extrusion.  
![apa-expected-seam](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/pa/apa-expected-seam.jpg?raw=true)

Solid infill should have no gaps, pinholes, or separation from the perimeters.  
![apa-expected-solid-infill](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/pa/apa-expected-solid-infill.jpg?raw=true)
...
![apa-unexpected-solid-infill](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/pa/apa-unexpected-solid-infill.jpg?raw=true)
...
![apa-test210](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/pa/apa-test210.png?raw=true)
...
![pa-pattern-general](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/pa/pa-pattern-general.png?raw=true)

#### CosmoSlice 2.3.0 and newer
...
![pa-pattern-batch](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/pa/pa-pattern-batch.png?raw=true)
...
#### CosmoSlice 2.2.0 and older

Setup your PA test as usual from the calibration menu in CosmoSlice. Once setup, your PA test should look like the below:

![apa-setup-result-speed](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/pa/apa-setup-result-speed.png?raw=true)

![apa-setup-result-acceleration-jerk](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/pa/apa-setup-result-acceleration-jerk.png?raw=true)
...
![apa-profile](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/pa/apa-profile.png?raw=true)
...
- **Too high PA**
![apa-identify-too-high](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/pa/apa-identify-too-high.jpg?raw=true)

- **Too low PA**
![apa-identify-too-low](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/pa/apa-identify-too-low.jpg?raw=true)

- **Optimal PA**
![apa-identify-optimal](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/pa/apa-identify-optimal.jpg?raw=true)
