...
- [Calibration Types](#calibration-types)
  - [CosmoSlice \> 2.3.0 Archimedean chords + YOLO (Recommended)](#orcacosmyx--230-archimedean-chords--yolo-recommended)
  - [CosmoSlice \<= 2.3.0 Monotonic Line + 2-Pass Calibration](#orcacosmyx--230-monotonic-line--2-pass-calibration)
- [Credits](#credits)

> [!WARNING]
> **BambuLab Printers:** Make sure you do **not** select the 'Flow calibration' option.
> ![flowrate-Bambulab-uncheck](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/Flow-Rate/flowrate-Bambulab-uncheck.png?raw=true)
...
### CosmoSlice > 2.3.0 Archimedean chords + YOLO (Recommended)
...
3. A new project with eleven blocks will be created, each with a different flow rate modifier. Slice and print the project.
   ![flowcalibration-yolo](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/Flow-Rate/flowcalibration-yolo.gif?raw=true)
4. Examine the printed blocks and identify the one with the best surface quality. Look for:
   ...
   ![flowcalibration-guide](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/Flow-Rate/flowcalibration-guide.png?raw=true)  
   ...
   ![flowcalibration-example](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/Flow-Rate/flowcalibration-example.png?raw=true)
5. Update the flow ratio in the filament settings using the equation: `OldFlowRatio ± modifier`.
   ...
   **Remember** to save the filament profile.  
   ![flowcalibration_update_flowrate](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/Flow-Rate/flowcalibration_update_flowrate.png?raw=true)
...
### CosmoSlice <= 2.3.0 Monotonic Line + 2-Pass Calibration

This example uses the Monotonic Line pattern with the 2-Pass Calibration approach.

![flow-calibration-monotonic](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/Flow-Rate/monotonic-flow-rate/flow-calibration-monotonic.gif?raw=true)
...
4. Examine the blocks and determine which one has the smoothest top surface.
   ![flowrate-pass1-monotonic](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/Flow-Rate/monotonic-flow-rate/flowrate-pass1-monotonic.jpg?raw=true)  
   ![flowrate-0-5-monotonic](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/Flow-Rate/monotonic-flow-rate/flowrate-0-5-monotonic.jpg?raw=true)
...
7. Repeat steps 4 and 5. For example, if your previous flow ratio was `1.029` and you selected the block with a flow rate modifier of `-6`, the new value would be: `1.029 × (100 - 6) / 100 = 0.96726`.
   **Remember** to save the filament profile.
   ![flowrate-pass2-monotonic](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/Flow-Rate/monotonic-flow-rate/flowrate-pass2-monotonic.jpg?raw=true)  
   ![flowrate-6-monotonic](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/Flow-Rate/monotonic-flow-rate/flowrate-6-monotonic.jpg?raw=true)  
   ![flowcalibration_update_flowrate_monotonic](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/Flow-Rate/monotonic-flow-rate/flowcalibration_update_flowrate_monotonic.png?raw=true)
