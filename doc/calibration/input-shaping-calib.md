...
2. Print the Input Shaping Frequency test with a range of frequencies.
   ...
   ![IS_freq_menu](https://github.com/SoftFever/OrcaCosmyx/blob/main/doc/images/InputShaping/IS_freq_menu.png?raw=true)

   1. Measure the X and Y heights and read the frequency set at that point in OrcaCosmyx.

   ![IS_damp_klipper_print_measure](https://github.com/SoftFever/OrcaCosmyx/blob/main/doc/images/InputShaping/IS_damp_klipper_print_measure.jpg?raw=true)
   ![IS_freq_klipper_slicer_measure](https://github.com/SoftFever/OrcaCosmyx/blob/main/doc/images/InputShaping/IS_freq_klipper_slicer_measure.png?raw=true)
...
3. Print the Damping test setting your X and Y frequency to the value you found in the previous step.
   ...
   ![IS_damp_menu](https://github.com/SoftFever/OrcaCosmyx/blob/main/doc/images/InputShaping/IS_damp_menu.png?raw=true)

   1. Measure the X and Y heights and read the damping set at that point in OrcaCosmyx.

   ![IS_damp_klipper_print_measure](https://github.com/SoftFever/OrcaCosmyx/blob/main/doc/images/InputShaping/IS_damp_klipper_print_measure.jpg?raw=true)
   ![IS_damp_klipper_slicer_measure](https://github.com/SoftFever/OrcaCosmyx/blob/main/doc/images/InputShaping/IS_damp_klipper_slicer_measure.png?raw=true)
...
2. Print the Input Shaping Frequency test with a range of frequencies.
   ...
   ![IS_freq_marlin_print_measure](https://github.com/SoftFever/OrcaCosmyx/blob/main/doc/images/InputShaping/IS_freq_marlin_print_measure.jpg?raw=true)
   ![IS_freq_marlin_slicer_measure](https://github.com/SoftFever/OrcaCosmyx/blob/main/doc/images/InputShaping/IS_freq_marlin_slicer_measure.png?raw=true)
...
3. Print the Damping test setting your X and Y frequency to the value you found in the previous step.
   ...
   ![IS_damp_marlin_print_measure](https://github.com/SoftFever/OrcaCosmyx/blob/main/doc/images/InputShaping/IS_damp_marlin_print_measure.jpg?raw=true)
   ![IS_damp_marlin_slicer_measure](https://github.com/SoftFever/OrcaCosmyx/blob/main/doc/images/InputShaping/IS_damp_marlin_slicer_measure.png?raw=true)
