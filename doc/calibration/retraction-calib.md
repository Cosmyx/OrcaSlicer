...
![retraction_test](https://github.com/SoftFever/OrcaCosmyx/blob/main/doc/images/retraction/retraction_test.gif?raw=true)

![retraction_test_menu](https://github.com/SoftFever/OrcaCosmyx/blob/main/doc/images/retraction/retraction_test_menu.png?raw=true)
...
![retraction_test_print](https://github.com/SoftFever/OrcaCosmyx/blob/main/doc/images/retraction/retraction_test_print.jpg?raw=true)

> [!NOTE]
> When testing filaments such as PLA or ABS that have minimal oozing, the retraction settings can be highly effective. You may find that the retraction tower appears clean right from the start. In such situations, setting the retraction length to 0.2mm - 0.4mm using OrcaCosmyx should suffice.
