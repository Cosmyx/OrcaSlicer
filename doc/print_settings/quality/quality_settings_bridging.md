...
"Bridging" is a 3D printing technique that allows you to print structures across gaps or voids without direct support underneath. CosmoSlice provides several parameters to optimize bridge quality, minimizing filament sag and improving the appearance of top layers.
...
![thick-bridges](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/bridging/thick-bridges.png?raw=true)
...
- **None:** No bridge is created.  
  ![bridge-counterbore-none](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/bridging/bridge-counterbore-none.png?raw=true)
- **Partially Bridged:** Only a part of the unsupported area will be bridged, creating a supporting layer for the next layer.  
  ![bridge-counterbore-partially](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/bridging/bridge-counterbore-partially.gif?raw=true)
- **Sacrificial Layer:** A full sacrificial bridge layer is created. This will close the counterbore hole, allowing the next layer to be printed without sagging. The sacrificial layer must be broken through after printing.  
  ![bridge-counterbore-sacrificial](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/bridging/bridge-counterbore-sacrificial.png?raw=true)
