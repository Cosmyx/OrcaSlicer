...
![arc-fitting](https://github.com/Cosmyx/OrcaSlicer/blob/main/doc/images/Precision/arc-fitting.svg?raw=true)
...
Follow the [Calibration Guide](https://github.com/Cosmyx/OrcaSlicer/wiki/Calibration) and [Filament Tolerance Calibration](https://github.com/Cosmyx/OrcaSlicer/wiki/tolerance-calib) to determine the correct value for your printer and filament combination.
...
![elephant-foot](https://github.com/Cosmyx/OrcaSlicer/blob/main/doc/images/Precision/elephant-foot.svg?raw=true)
...
![elephant-foot-compensation](https://github.com/Cosmyx/OrcaSlicer/blob/main/doc/images/Precision/elephant-foot-compensation.png?raw=true)
...
- **Precise Wall Off**
  ...
  ![PreciseWallOff](https://github.com/Cosmyx/OrcaSlicer/blob/main/doc/images/Precision/PreciseWallOff.svg?raw=true)

- **Precise Wall On**

  ![PreciseWallOn](https://github.com/Cosmyx/OrcaSlicer/blob/main/doc/images/Precision/PreciseWallOn.svg?raw=true)
...
- **Precise Z Height Off**
  ...
  ![PreciseZOff](https://github.com/Cosmyx/OrcaSlicer/blob/main/doc/images/Precision/PreciseZOff.png?raw=true)

- **Precise Z Height On**

  ![PreciseZOn](https://github.com/Cosmyx/OrcaSlicer/blob/main/doc/images/Precision/PreciseZOn.png?raw=true)
...
![PolyHoles](https://github.com/Cosmyx/OrcaSlicer/blob/main/doc/images/Precision/PolyHoles.png?raw=true)
