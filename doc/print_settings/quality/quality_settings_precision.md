...
![arc-fitting](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/Precision/arc-fitting.svg?raw=true)
...
Follow the [Calibration Guide](https://github.com/SoftFever/CosmoSlice/wiki/Calibration) and [Filament Tolerance Calibration](https://github.com/SoftFever/CosmoSlice/wiki/tolerance-calib) to determine the correct value for your printer and filament combination.
...
![elephant-foot](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/Precision/elephant-foot.svg?raw=true)

To mitigate this effect, CosmoSlice allows you to specify a negative distance that will be applied to the first specified number of layers. This adjustment effectively reduces the width of the first few layers, helping to achieve a more accurate final print size.

![elephant-foot-compensation](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/Precision/elephant-foot-compensation.png?raw=true)

## Precise wall

The 'Precise Wall' is a distinctive feature introduced by CosmoSlice, aimed at improving the dimensional accuracy of prints and minimizing layer inconsistencies by slightly increasing the spacing between the outer wall and the inner wall.
...
Slic3r and its forks, such as PrusaSlicer, SuperSlicer and CosmoSlice, assume that the extrusion path has an oval shape, which accounts for the overlaps. For example, if we set the wall width to 0.4mm and the layer height to 0.2mm, the combined thickness of two walls laid side by side is 0.714mm instead of 0.8mm due to the overlapping.

- **Precise Wall Off**

  ![PreciseWallOff](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/Precision/PreciseWallOff.svg?raw=true)

- **Precise Wall On**

  ![PreciseWallOn](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/Precision/PreciseWallOn.svg?raw=true)
...
CosmoSlice adheres to Slic3r's approach to handling flow. To address the downsides mentioned earlier, CosmoSlice introduced the 'Precise Wall' feature. When this feature is enabled in CosmoSlice, the overlap between the outer wall and its adjacent inner wall is set to zero. This ensures that the overall strength of the printed part is unaffected, while the size accuracy and layer consistency are improved.
...
- **Precise Z Height Off**
  ...
  ![PreciseZOff](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/Precision/PreciseZOff.png?raw=true)

- **Precise Z Height On**

  ![PreciseZOn](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/Precision/PreciseZOn.png?raw=true)
...
![PolyHoles](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/Precision/PolyHoles.png?raw=true)
