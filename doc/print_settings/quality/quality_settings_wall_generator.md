...
![wallgenerator-classic](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/WallGenerator/wallgenerator-classic.png?raw=true)
...
![wallgenerator-arachne](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/WallGenerator/wallgenerator-arachne.png?raw=true)
...
> Use the One Wall Threshold (in Advanced settings) to adjust how aggressively CosmoSlice considers a region a top surface. This option only appears when this setting exceeds 0.5, or if single-wall top surfaces are enabled.
