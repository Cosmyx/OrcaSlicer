...
![ers-intro](https://github.com/SoftFever/OrcaCosmyx/blob/main/doc/images/ERS/ers-intro.png?raw=true)
...
![ers-artefact](https://github.com/SoftFever/OrcaCosmyx/blob/main/doc/images/ERS/ers-artefact.jpg?raw=true)
...
A printer's motion system does not exactly follow the speed changes seen in the G-code preview screen of OrcaCosmyx.
...
![ers-printspeed](https://github.com/SoftFever/OrcaCosmyx/blob/main/doc/images/ERS/ers-printspeed.png?raw=true)
...
Ideally, you want this value set to 1 to allow for the largest number of steps between each speed transition. However, this may result in G-code that is too large, with too many commands sent to your MCU per second and it may not be able to keep up. It will also slow down the OrcaCosmyx front end as the sliced model is more complex to render.
