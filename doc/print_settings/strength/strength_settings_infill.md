...
![infill-multiline-1-5](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/fill/infill-multiline-1-5.gif?raw=true)
...
![infill-multiline-aesthetic](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/fill/infill-multiline-aesthetic.gif?raw=true)
...
>
> ![infill-multiline-overlapping](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/fill/infill-multiline-overlapping.gif?raw=true)
...
![fill-direction](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/fill/fill-direction.png?raw=true)
...
![fill-rotation](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/fill/fill-rotation.png?raw=true)
...
![InfillWallOverlapOff](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/fill/InfillWallOverlapOff.svg?raw=true)

- **Infill Wall Overlap On**

![InfillWallOverlapOn](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/fill/InfillWallOverlapOn.svg?raw=true)
...
CosmoSlice tries to connect two close infill lines to a short perimeter segment. If no such perimeter segment shorter than this parameter is found, the infill line is connected to a perimeter segment at just one side and the length of the perimeter segment taken is limited to infill_anchor, but no longer than this parameter. If set to 0, the old algorithm for infill connection will be used, it should create the same result as with 1000 & 0.

- **Anchor Off**

![InfillAnchorOff](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/fill/InfillAnchorOff.png?raw=true)

- **Anchor On**

![InfillAnchorOn](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/fill/InfillAnchorOn.png?raw=true)
...
![extra-solid-infill](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/fill/extra-solid-infill.gif?raw=true)
