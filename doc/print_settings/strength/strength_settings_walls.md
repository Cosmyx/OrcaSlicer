...
![walls](https://github.com/Cosmyx/OrcaSlicer/blob/main/doc/images/walls/walls.png?raw=true)
...
- In small details it can generate details that wouldn't be possible with traditional wall generation methods.  
  ![walls-small-detect-thin-off](https://github.com/Cosmyx/OrcaSlicer/blob/main/doc/images/walls/walls-small-detect-thin-off.png?raw=true)
  ![walls-small-detect-thin-on](https://github.com/Cosmyx/OrcaSlicer/blob/main/doc/images/walls/walls-small-detect-thin-on.png?raw=true)
- In large prints, it can generate defects more easily due to the reduced wall thickness.
  ![walls-big-detect-thin-off-on](https://github.com/Cosmyx/OrcaSlicer/blob/main/doc/images/walls/walls-big-detect-thin-off-on.png?raw=true)
