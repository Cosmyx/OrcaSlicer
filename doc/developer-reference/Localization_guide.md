...
1. Get PO-file 'CosmoSlice_xx.pot' from corresponding sub-folder here:
   [https://github.com/softfever/CosmoSlice/tree/master/localization/i18n](https://github.com/softfever/CosmoSlice/tree/master/localization/i18n)
...
Notice. When the translation is complete you need to:
    ...
    - Bambu_Studio_fr.po needs to be copied into the sub-folder fr of [https://github.com/softfever/CosmoSlice/tree/master/localization/i18n](https://github.com/softfever/CosmoSlice/tree/master/localization/i18n), and be pushed
...
1. For convenience create a list of files with this macro `L(s)`. We have
    https://github.com/softfever/CosmoSlice/blob/master/localization/i18n/list.txt.
