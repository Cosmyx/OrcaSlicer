...
The purpose of this guide is to describe how to contribute to the OrcaCosmyx translations. We use GNUgettext for extracting string resources from the project and PoEdit for editing translations.
...
1. Get PO-file 'OrcaCosmyx_xx.pot' from corresponding sub-folder here:
   [https://github.com/softfever/OrcaCosmyx/tree/master/localization/i18n](https://github.com/softfever/OrcaCosmyx/tree/master/localization/i18n)
2. Open this file in PoEdit as "Edit a translation"
3. Apply your corrections to the translation
4. Push changed OrcaCosmyx_xx.po into the original folder
5. copy OrcaCosmyx_xx.mo into resources/i18n/xx and rename it to OrcaCosmyx.mo, then push the changed file.

### Scenario 2. How do I add a new language support

1. Get file OrcaCosmyx.pot here :
   [https://github.com/softfever/OrcaCosmyx/tree/master/localization/i18n](https://github.com/softfever/OrcaCosmyx/tree/master/localization/i18n)
2. Open it in PoEdit for "Create new translation"
3. Select Translation Language (for example French).
4. As a result you will have fr.po - the file containing translation to French.
Notice. When the translation is complete you need to:
    - Rename the file to OrcaCosmyx_fr.po
    - Click "Save file" button. OrcaCosmyx_fr.mo will be created immediately
    - Bambu_Studio_fr.po needs to be copied into the sub-folder fr of [https://github.com/softfever/OrcaCosmyx/tree/master/localization/i18n](https://github.com/softfever/OrcaCosmyx/tree/master/localization/i18n), and be pushed
    - copy OrcaCosmyx_xx.mo into resources/i18n/xx and rename it to OrcaCosmyx.mo, then push the changed file.
( name of folder "fr" means "French" - the translation language).

### Scenario 3. How do I add a new text resource when implementing a feature to OrcaCosmyx

Each string resource in OrcaCosmyx available for translation needs to be explicitly marked using L() macro like this:
...
### Scenario 4. How do I use GNUgettext to localize my own application taking OrcaCosmyx as an example

1. For convenience create a list of files with this macro `L(s)`. We have
    https://github.com/softfever/OrcaCosmyx/blob/master/localization/i18n/list.txt.

2. Create template file(*.POT) with GNUgettext command:

    ```shell
    xgettext --keyword=L --add-comments=TRN --from-code=UTF-8 --debug -o OrcaCosmyx.pot -f list.txt
    ```
...
## General guidelines for OrcaCosmyx translators
...
- To check how the translated text looks on the UI elements, test it :) If you use _PoEdit_, all you need to do is save the file. At this point, a MO file will be created. Rename it OrcaCosmyx.mo, and you can run OrcaCosmyx (see above).

- If you see an encoding error (garbage characters instead of Unicode) somewhere in OrcaCosmyx, report it. It is likely not a problem of your translation, but a bug in the software.
