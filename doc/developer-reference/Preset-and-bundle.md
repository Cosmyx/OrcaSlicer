...
## [`Preset`](https://github.com/SoftFever/OrcaCosmyx/blob/main/src/libslic3r/Preset.hpp)
...
![process-preset-full](https://github.com/SoftFever/OrcaCosmyx/blob/main/doc/images/GUI/process-preset-full.png?raw=true)
...
## [`PresetBundle`](https://github.com/SoftFever/OrcaCosmyx/blob/main/src/libslic3r/PresetBundle.hpp)
...
## [`PresetCollection`](https://github.com/SoftFever/OrcaCosmyx/blob/main/src/libslic3r/Preset.hpp)
