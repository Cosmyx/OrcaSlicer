...
## [`Preset`](https://github.com/Cosmyx/OrcaSlicer/blob/main/src/libslic3r/Preset.hpp)
...
![process-preset-full](https://github.com/Cosmyx/OrcaSlicer/blob/main/doc/images/GUI/process-preset-full.png?raw=true)
...
## [`PresetBundle`](https://github.com/Cosmyx/OrcaSlicer/blob/main/src/libslic3r/PresetBundle.hpp)
...
## [`PresetCollection`](https://github.com/Cosmyx/OrcaSlicer/blob/main/src/libslic3r/Preset.hpp)
