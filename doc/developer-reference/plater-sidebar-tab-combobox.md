...
## [`Plater`](https://github.com/SoftFever/CosmoSlice/blob/main/src/slic3r/GUI/Plater.hpp)
...
## [`Sidebar`](https://github.com/SoftFever/CosmoSlice/blob/main/src/slic3r/GUI/Plater.hpp)

This is relating the the sidebar in the application window

![full-sidebar](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/GUI/full-sidebar.png?raw=true)

## [`ComboBox`](https://github.com/SoftFever/CosmoSlice/blob/main/src/slic3r/GUI/Widgets/ComboBox.hpp)
...
## [`Tab`](https://github.com/SoftFever/CosmoSlice/blob/main/src/slic3r/GUI/Tab.hpp)
...
![tab-popup](https://github.com/SoftFever/CosmoSlice/blob/main/doc/images/GUI/tab-popup.png?raw=true)
