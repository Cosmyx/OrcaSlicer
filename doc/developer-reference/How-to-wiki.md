...
This guide explains how to contribute to the OrcaCosmyx wiki.

OrcaCosmyx uses GitHub's wiki feature, which lets users and developers create and edit documentation collaboratively.
...
The Home page is the starting point for the OrcaCosmyx wiki. From there you can navigate to sections and topics related to the project.
...
- ![printer](https://github.com/SoftFever/OrcaCosmyx/blob/main/resources/images/printer.svg?raw=true) [Printer Settings](home#printer-settings)
- ![filament](https://github.com/SoftFever/OrcaCosmyx/blob/main/resources/images/filament.svg?raw=true) [Material Settings](home#material-settings)
- ![process](https://github.com/SoftFever/OrcaCosmyx/blob/main/resources/images/process.svg?raw=true) [Process Settings](home#process-settings)
- ![tab_3d_active](https://github.com/SoftFever/OrcaCosmyx/blob/main/resources/images/tab_3d_active.svg?raw=true) [Prepare](home#prepare)
- ![tab_calibration_active](https://github.com/SoftFever/OrcaCosmyx/blob/main/resources/images/tab_calibration_active.svg?raw=true) [Calibrations](home#calibrations)
- ![im_code](https://github.com/SoftFever/OrcaCosmyx/blob/main/resources/images/im_code.svg?raw=true) [Developer Section](home#developer-section)
...
OrcaCosmyx can redirect users from the GUI to the appropriate wiki pages, making it easier to find relevant documentation.

The option-to-wiki mapping is defined in [src/slic3r/GUI/Tab.cpp](https://github.com/SoftFever/OrcaCosmyx/blob/main/src/slic3r/GUI/Tab.cpp). Any option added with `append_single_option_line` can be mapped to a wiki page using a second string argument.
...
- Base URL:
  ...
  ```markdown
  https://github.com/SoftFever/OrcaCosmyx/blob/main/doc/images/
  ```
...
- For an image in `doc/images/` named `calibration.png`:
  ...
  ```markdown
  ![calibration](https://github.com/SoftFever/OrcaCosmyx/blob/main/doc/images/calibration.png?raw=true)
  ```

- For an image in a subdirectory like `doc/images/GUI/combobox.png`:

  ```markdown
  ![combobox](https://github.com/SoftFever/OrcaCosmyx/blob/main/doc/images/GUI/combobox.png?raw=true)
  ```
...
```html
<img alt="IS_damp_marlin_print_measure" src="https://github.com/SoftFever/OrcaCosmyx/blob/main/doc/images/InputShaping/IS_damp_marlin_print_measure.jpg?raw=true" height="200">
```
...
- **GUI-based reference:** Describe settings following OrcaCosmyx's UI when sequence isn't required.
