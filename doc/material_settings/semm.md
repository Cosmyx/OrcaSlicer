# Single Extruder Multimaterial Printing in OrcaCosmyx

## Introduction

In this guide, we will explain the parameters for single extruder multimaterial printing in OrcaCosmyx. The whole process and parameters are same as PrusaSlicer as OrcaCosmyx is based on PrusaSlicer.
OrcaCosmyx has some additional features and minor differences though. We will explain them in this guide.
